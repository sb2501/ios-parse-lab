...
**Chat Parse** is a Chat app using an [open source Parse](http://parseplatform.org/) backend.
...
<img src='https://i.imgur.com/RggpCsL.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
